	  ...
	  <div class="panel panel-default">
		...
		<div class="panel-body" id="wform" style="display : none;">
			...
			<table class="table">
				...
				<tr>
					<td>작성자</td>
					<td><input type="text" name="writer" readonly value ="${mvo.memName}" class="form-control"></td>
				</tr>
				<tr>
	...
	<script type="text/javascript">
		...
		function makeView(data){
			...
			$.each(data, function(index, obj){
				...
				listHtml += "<button onclick='goDelete(" + obj.idx + ")' class='btn btn-sm btn-warning' aria-disabled>삭제</button> &nbsp;"
				}else{
					listHtml += "<br>";
					listHtml += "<span id='ub"+ obj.idx +"'>";
					listHtml += "<button onclick='goUpdateForm(" + obj.idx + ")' class='btn btn-sm btn-success'>수정화면</button></span> &nbsp;"
