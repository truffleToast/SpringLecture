      ...
      <ul class="nav navbar-nav navbar-right">
      			<li>
      				<c:if test="${mvo.memProfile eq ''}">
      					<img class="img-rounded" style ="width:50px; height: 50px;" src ="${contextPath}/resources/images/default.jpg">
      				</c:if>
      				<c:if test ="${mvo.memProfile ne ''}">
      					<img class="img-rounded" style ="width:50px; height: 50px;" src ="${contextPath}/resources/profile/${mvo.memProfile}">
      				</c:if>
      				<span>${mvo.memName}님 welcome</span>
      			</li>
		        <li><a href="${contextPath}/updateForm.do">회원정보수정<span class ="glyphicon glyphicon-pencil"></span></a></li>
