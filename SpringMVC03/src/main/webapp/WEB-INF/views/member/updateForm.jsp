		...
		<form action="${contextPath}/update.do" method="post">
			...
			<table style="text-align: center; border : 1px solid #dddddd" class="table table-bordered">
				...
				<tr>
					...
					<td colspan="2"><input required="required" type="password" onkeyup="passwordCheck()"  name="memPassword1" id="memPassword1" class="form-control" maxlength="20" value="${mvo.memPassword}"></td>
				</tr>
				
				<tr>
					<td style="width: 110px; vertical-align: middle;">비밀번호확인</td>
					<td colspan="2"><input type="password" onkeyup="passwordCheck()" name="memPassword2" id="memPassword2" class="form-control" maxlength="20" value="${mvo.memPassword}"></td>
				</tr>
				
				<tr>
					<td style="width: 110px; vertical-align: middle;">사용자이름</td>
					<td colspan="2"><input  type="text" id="memName" name="memName" class="form-control" maxlength="20" value="${mvo.memName}"></td>
				</tr>
				
				<tr>
					<td style="width: 110px; vertical-align: middle;">나이</td>
					<td colspan="2"><input type="number" id="memAge" name="memAge" class="form-control" maxlength="20" value="${mvo.memAge}"></td>
				</tr>
				...
				<tr>
					...
					<td colspan="2"><input value="${mvo.memEmail}" type="email" name="memEmail" id="memEmail" class="form-control" maxlength="50" value="${mvo.memEmail}"></td>
				</tr>
